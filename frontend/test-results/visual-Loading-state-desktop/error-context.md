...
- Name: visual.spec.ts >> Loading state
- Location: e2e/visual.spec.ts:53:1
...
Call log:
  - waiting for locator('p:has-text("Loading...")') to be visible
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    ...
    - generic "Chargement du calendrier annuel" [ref=e14]
```
