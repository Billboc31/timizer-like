...
- Name: client-signing.spec.ts >> Client signing workflow >> second visit with consumed token shows error state
- Location: e2e/client-signing.spec.ts:109:3
...
Expected substring: "Ce lien est invalide, expiré ou déjà utilisé."
Received string:    "Failed to list CRAs: 502"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for getByRole('alert')
    14 × locator resolved to <p role="alert">Failed to list CRAs: 502</p>
       - unexpected value "Failed to list CRAs: 502"
