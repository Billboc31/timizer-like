...
- Name: visual.spec.ts >> Error state
- Location: e2e/visual.spec.ts:63:1
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  16972 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: error-state.png

Call log:
  - Expect "toHaveScreenshot(error-state.png)" with timeout 5000ms
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    ...
    - generic [ref=e14]:
      - alert [ref=e15]:
        - generic [ref=e16]: ⚠
        - generic [ref=e17]: Une erreur est survenue. Veuillez réessayer.
      - button "Réessayer" [ref=e18] [cursor=pointer]
```
