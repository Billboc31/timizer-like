...
public final class CraDetailsMapper {
    ...
    public static CraDetailsDto toDto(MonthlyCraReport report) {
        ...
        return new CraDetailsDto(
                ...
                report.getProviderRaisonSociale(),
                report.getProviderSiret(),
                report.getProviderAdresse(),
                report.getProviderCodePostal(),
                report.getProviderVille(),
                report.getProviderPays(),
    ...
    public static CraStatus mapStatus(ValidationStatus status) {
        return switch (status) {
            ...
            case FULLY_SIGNED -> CraStatus.VALIDATED;
        };
    }
}
