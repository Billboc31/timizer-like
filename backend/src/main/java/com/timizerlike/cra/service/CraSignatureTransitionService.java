...
public class CraSignatureTransitionService {
    ...
    @Transactional
    public CraDetailsDto signByProvider(Long craId, LocalDate providerSignatureDate, String signatureImageBase64) {
        ...
        cra.setProviderSignatureImage(signatureImageBase64);
        cra.setProviderSignedAt(Instant.now());
        craRepository.save(cra);
        return CraDetailsMapper.toDto(cra);
    }
